...
var DarkTintBatcher = class _DarkTintBatcher extends Batcher {
  ...
  packAttributes(element, float32View, uint32View, index, textureId) {
    ...
    const darkColor = Color2.shared.setValue(element.darkColor).premultiply(worldAlpha, true).toPremultiplied(1, false);
...
var Spine = class _Spine extends ViewContainer {
      ...
      if (attachment) {
        if (attachment instanceof MeshAttachment || attachment instanceof RegionAttachment) {
          ...
          if (this.alpha === 0 || alpha === 0) {
            ...
            const texture = sequence.regions[sequenceIndex]?.texture?.texture || Texture2.EMPTY;
  ...
  unloadFromCache() {
    ...
    if (Cache.get(cacheKey) !== skeletonData) return false;
  ...
  static createOptions({ skeleton, atlas, scale = 1, darkTint, autoUpdate = true, boundsProvider, allowMissingRegions = false, ticker }) {
    ...
    if (Cache.has(cacheKey)) {
      const skeletonData2 = Cache.get(cacheKey);

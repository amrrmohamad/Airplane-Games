import { A as DOMAdapter, B as Bounds, R as warn, U as BufferImageSource, V as Texture, W as TextureSource, c as BindGroup, dt as extensions, it as Matrix, l as UniformGroup, nt as Rectangle, p as GpuProgram, s as RendererType, t as Geometry, ut as ExtensionType, x as GlProgram } from "./Geometry-B9QXP4-o.js";
import { A as boundsPool, C as getLocalBounds, D as getGlobalBounds, g as TexturePool, j as matrixPool, l as Container, o as CanvasSource, r as Ticker, s as Sprite, t as Filter } from "./Filter-CSXKw0nJ.js";
import { t as ImageSource } from "./ImageSource--KuTY2Fr.js";
import { n as convertToList, t as Cache } from "./Cache-Dx3EMhLj.js";
import { t as canvasUtils } from "./canvasUtils-Cgnuofii.js";
import { t as CanvasPool } from "./CanvasPool-DoDExXro.js";
...
var CanvasFilterSystem = class {
	...
	*/
	generateFilteredTexture({ texture, filters }) {
		...
		if (cssFilters.length === 0 && true) return texture;
...
//#endregion
export { VideoSource as C, AlphaMask as D, ColorMask as E, addMaskLocalBounds as O, textureFrom as S, StencilMask as T, createStringVariations as _, isCanvasFilterCapable as a, autoDetectSource as b, source as c, spritesheetAsset as d, Spritesheet as f, isSingleItem as g, getUrlExtension as h, CanvasFilterSystem as i, addMaskBounds as k, fragment as l, Resolver as m, FilterPipe as n, getPo2TextureFromSource as o, copySearchParams as p, PassthroughFilter as r, getGlobalRenderableBounds as s, FilterSystem as t, vertex as u, path as v, detectVideoAlphaMode as w, resourceToTexture as x, LoaderParserPriority as y };
